...
public interface VParticleData {
    static VParticleData of(ItemStack item) {
    ...
    static DustOptions createDustOptions(Color color, float size) {
        ...
        if (VParticleTypes.DUST_OPTIONS_CLASS == null) {
    ...
    static DustTransition createDustTransition(Color fromColor, Color toColor, float size) {
        ...
        if (VParticleTypes.DUST_TRANSITION_CLASS == null) {
    ...
    class AbstractParticleData implements VParticleData {
        final Object data;
