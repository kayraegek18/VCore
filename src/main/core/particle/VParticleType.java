...
public interface VParticleType {
    /**
    ...
    default Class<?> getDataType() {
        ...
        return VParticleTypes.DATA_ADAPTERS.getOrDefault(type, type);
    }
     ...
     * at the target location.
     *
     * @param <T>      type of particle data (see {@link VParticleType#getDataType()}
     * @param world    the world to spawn particle to
     * @param location the location to spawn at
     * @param count    the number of particles
     * @param data     the data to use for the particle or null,
     *                 the type of this depends on {@link VParticleType#getDataType()}
     */
